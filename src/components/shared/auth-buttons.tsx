  ...
  return (
    <>
      ...
      <div className="space-y-4 md:space-y-6">
        <Link
          href="#"
          className="border-stroke-3/18 hover:bg-stroke-3/10 group flex w-full items-center justify-center gap-2 rounded-md border bg-white px-8 py-3 transition-all duration-300 ease-in-out"
        >
          <span>
          ...
          <span className="text-tagline-3 text-background-13/90 font-normal">Continue with Google</span>
        </Link>
        <Link
          href="#"
          className="border-stroke-3/18 hover:bg-stroke-3/10 group flex w-full items-center justify-center gap-2 rounded-md border bg-white px-8 py-3 transition-all duration-300 ease-in-out"
        >
          ...
          <span className="text-tagline-3 text-background-13/90 font-normal">Continue with facebook</span>
        </Link>
      </div>
    </>
  );
