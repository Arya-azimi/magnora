...
export default async function Solutions() {
  const services = await executeQuery<ServiceFromDB[]>({
    query:
      "SELECT id, slug, title, description, icon FROM services ORDER BY id ASC",
  });

  return (
    <section
      className="py-[80px] md:py-[120px] xl:py-[156px]"
      aria-labelledby="Smart-solutions"
    >
        ...
        <div className="space-y-14">
          <div className="space-y-3">
            ...
            <TextReveal delay={0.4}>
              <p className="font-inter-tight text-tagline-1 text-background-13/60 mx-auto max-w-[390px] text-center font-normal">
                Empowering industries with AI-driven innovation to solve
